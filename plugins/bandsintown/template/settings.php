...
$gig = (new \Ivy\Plugin)->where('name', "Gig")->getRow()->single();
?>

<form action="<?= _BASE_PATH . '/bandsintown/post'; ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <tr>
                        ...
                        <td>
                            <label for="response" class="close text-align-right">
                                <?= file_get_contents(_BASE_PATH . "media/icon/" . "feather/code.svg"); ?>
                            </label>
                        </td>
                        <td>
...
<?php if ($gig->active): ?>
    <form action="<?= _BASE_PATH . '/bandsintown/render'; ?>" method="POST" enctype="multipart/form-data">
        <div class="p-1">
            <div class="p-05 text-center">
          ...
          <span class="select-arrow">
            <?= file_get_contents(_BASE_PATH . "media/icon/" . "feather/chevron-down.svg"); ?>
          </span>
                    <label>
                        <select name="subject">
            ...
            <div class="inner text-align-center">
                <?php \Ivy\Button::submit('render gigs'); ?>
            </div>
        </div>
    </form>
<?php endif; ?>

<?php
$gig = (new \Gig\Item)->where('id', $item->table_id)->fetchOne();
$tag = (new \Tag\Item)->where('id', $gig->subject)->fetchOne();
?>
...
<div class="item item-gig col-12 <?php if (!$item->parent): ?>col-6-md col-4-lg<?php endif; ?>"
    ...
    <form action="<?= Path::get('BASE_PATH') . 'gig/update/' . $item->id . \Ivy\Template::$url; ?>" method="POST"

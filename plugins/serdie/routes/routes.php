...
if (User::isLoggedIn()) {
    if (User::canEditAsEditor()) {
        ...
        $router->get('/serdie/wordlist', function () {
            ...
            Template::render(_PLUGIN_PATH . 'serdie/template/wordlist.php', ['wordlist' => $wordlist], 'main');
        });

        $router->get('/serdie/player', function () {
            $player = (new Player)->get()->all();
            Template::render(_PLUGIN_PATH . 'serdie/template/player.php', ['player' => $player], 'main');
        });

...
$youtube = (new Youtube)->where('id', $item->table_id)->getRow()->data();
?>
...
<div class="<?php if($item->class): print $item->class; else:?>item item-youtube col-12 col-md-6 col-lg-4<?php endif;?>" id="item-<?php print $item->id; ?>">
  <div class="inner">
    ...
    <?php if($item->author): ?>
      <form action="<?php print _BASE_PATH . 'youtube/update/' . $item->id . $page->url; ?>" method="POST" enctype="multipart/form-data">
